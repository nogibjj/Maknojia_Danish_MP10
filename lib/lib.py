...
def extract(url = "https://raw.githubusercontent.com/nogibjj/Maknojia_Danish_MP5/refs/heads/main/data/WRRankingsWeek5.csv", file_path="data/WRRankingsWeek5.csv", directory ="data"):
...
def example_transform(df):
    ...
    df = df.withColumn("Start_Sit_Recommendation", when(
        conditions[0], recommendations[0]
        ).when(conditions[1], recommendations[1]).otherwise("Bench"))
